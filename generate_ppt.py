...
# 定义颜色
PRIMARY_COLOR = RGBColor(0x1a, 0x52, 0x76)  # 深蓝
SECONDARY_COLOR = RGBColor(0x28, 0x74, 0xa6)  # 中蓝
ACCENT_COLOR = RGBColor(0x5d, 0xad, 0xe2)  # 浅蓝
...
def add_section_slide(prs, title):
    ...
    # 标题
    title_box = slide.shapes.add_textbox(Inches(4.5), Inches(3), Inches(8), Inches(1.5))
    tf = title_box.text_frame
    p = tf.paragraphs[0]
    p.text = title
    p.font.size = Pt(44)
    ...
    if is_table and table_data:
        ...
        for i, row in enumerate(table_data):
            for j, cell_text in enumerate(row):
                ...
                cell.text_frame.paragraphs[0].font.size = Pt(14 if i > 0 else 16)
                if i == 0:
...
# 第3页：项目背景与痛点
add_content_slide(prs, "1️⃣ 项目背景与痛点", [
    "皮肤疾病诊疗现状的三大痛点：",
    "",
...
# 第4页：项目概述
add_content_slide(prs, "2️⃣ 项目概述", [
    "皮诊智核是什么？",
    "",
...
# 第5页：技术架构总览
add_content_slide(prs, "3️⃣ 技术架构总览", [
    "四层架构设计：",
    "",
...
# 第6页：核心技术亮点①
add_content_slide(prs, "4️⃣ 核心技术亮点 ① — 深度学习模型", [
    "多模型融合策略：",
    "",
...
# 第7页：核心技术亮点②
add_content_slide(prs, "4️⃣ 核心技术亮点 ② — RAG知识增强", [
    "为什么需要RAG？",
    "",
    "传统LLM：可能'幻觉'，答案不可信",
...
# 第8页：核心技术亮点③
add_content_slide(prs, "4️⃣ 核心技术亮点 ③ — 多Agent智能协作", [
    "模仿真实医生会诊流程：",
    "",
    ...
    "            输出报告",
    "",
    "ReAct推理：每一步决策都有'思考过程'可追溯"
])

# 第9页：系统功能展示①
add_content_slide(prs, "5️⃣ 系统功能展示", [
    "三大核心功能模块：",
    "",
    "🖼️ 图像诊断 — 上传皮肤照片，AI识别病变类型，3秒出结果，初筛效率高",
    "",
...
# 第10页：系统功能展示②
add_content_slide(prs, "5️⃣ 系统功能展示 — 前端界面", [
...
# 第11页：模型性能评估
add_content_slide(prs, "6️⃣ 模型性能评估", [
    "分类性能指标：",
    "",
    "• 准确率 (Accuracy) — > 90%",
    "• 精确率 (Precision) — 待补充",
...
# 第12页：创新点总结
add_content_slide(prs, "7️⃣ 创新点总结", [
    "四大核心创新：",
    "",
...
# 第13页：应用场景
add_content_slide(prs, "8️⃣ 应用场景", [
    "三大应用场景：",
    "",
...
# 第14页：竞品对比
add_content_slide(prs, "9️⃣ 竞品对比", [
    "皮诊智核 vs 传统AI诊断：",
    "",
